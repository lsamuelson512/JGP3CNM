...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality -disable-lifetime-markers /T ps_6_6 /E EmitEditorSelectionDepthPS /Fc NaniteExportGBuffer.d3dasm /Fo NaniteExportGBuffer.dxil NaniteExportGBuffer.usf
:END
PAUSE
