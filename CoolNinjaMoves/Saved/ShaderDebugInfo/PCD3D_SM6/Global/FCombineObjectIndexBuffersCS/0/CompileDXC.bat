...
%DXC% -HV 2021 /auto-binding-space 0 /Zpr /O3 -Wno-parentheses-equality -disable-lifetime-markers /T cs_6_6 /E CombineObjectIndexBuffersCS /Fc LumenMeshSDFCulling.d3dasm /Fo LumenMeshSDFCulling.dxil LumenMeshSDFCulling.usf
:END
PAUSE
